 ...
 * Generated: 2026-08-05T15:28:46.937Z
 */
...
export const pistoiaTheme = {
  ...
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#0A756B, #2FD0BD)",
    ...
    "--color-text-secondary": "light-dark(#5A5D61, #A3A19E)",
    "--color-text-disabled": "light-dark(#A8AAAD, #66645F)",
    "--color-text-accent": "light-dark(#0A756B, #2FD0BD)",
    ...
    "--color-success": "light-dark(#187A4D, #45D089)",
    ...
    "--color-data-categorical-teal": "#0A756B",
