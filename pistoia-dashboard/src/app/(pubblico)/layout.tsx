  ...
  return (
    <div className="min-h-dvh">
      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 sm:px-6">
        ...
        {/* Fuori da `<main>` come in `AppShell`: un `<footer>` discendente di
            `main` non è un `contentinfo`, quindi non è un punto di riferimento
            per chi naviga a landmark. Qui non c'è barra laterale, perciò la
            larghezza non cambia — cambia solo il ruolo. */}
        <Footer />
      </div>
    </div>
  );
